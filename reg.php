			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
						...
						<input class="input100" type="text" name="user" placeholder="Digite seu usuario">
                    ...
                    <div class="wrap-input100 validate-input" >
						<span class="label-input100">Genero
                        <div class="p-t-10">
                    ...
                    <div class="wrap-input100 validate-input" ><label>
						<span class="label-input100" >Escolha sua foto!
                        <input type="file" name="f1"></span></label>
					</div>
